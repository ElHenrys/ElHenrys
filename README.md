# ¡Hola! Soy Henry Acosta 👋

### Data Analyst | BI Analyst | Process Optimizer

Me apasiona transformar datos en historias visuales y decisiones estratégicas. Mi enfoque principal es la **automatización de reportes** y la **optimización de procesos operativos** para generar un impacto real en el negocio. 

---

## 🚀 Sobre mí

- 📊 **Análisis de Datos:** Construcción de dashboards e interpretación de indicadores clave (KPIs).
- 🤖 **Automatización:** Especialista en agilizar flujos de trabajo con Python y AppScript.
- 💡 **Insights:** Orientado a la generación de información accionable para comunicación ejecutiva.
- 📈 **Mejora Continua:** Siempre buscando cómo hacer los procesos más eficientes y escalables.
...
![Mis estadísticas de GitHub](https://github-readme-stats.vercel.app/api?username=ElHenrys&show_icons=true&theme=radical)
![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=ElHenrys&layout=compact&theme=radical)
